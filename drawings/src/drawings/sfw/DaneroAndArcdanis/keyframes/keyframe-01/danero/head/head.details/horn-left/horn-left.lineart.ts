...
export const hornLeftLineart = (drawer: Group) => {
  //#region 1st ridge
  drawer
    .path(data.danero.head.horn.left['1']).stroke()
  ...
  //#region 2nd ridge
  drawer
    .path(data.danero.head.horn.left['2']).stroke()
  ...
  //#region 3rd ridge
  drawer
    .path(data.danero.head.horn.left['3']).stroke()
  ...
  //#region 4th ridge
  drawer
    .path(data.danero.head.horn.left['4']).stroke()
  ...
  //#region 5th ridge
  drawer
    .path(data.danero.head.horn.left['5']).stroke()
  ...
  //#region 6th ridge
  drawer
    .path(data.danero.head.horn.left['6']).stroke()
  ...
  //#region 7th ridge
  drawer
    .path(data.danero.head.horn.left['7']).stroke()
  ...
  //#region 4th ridge
  drawer
    .path(data.danero.head.horn.left['8']).stroke()
  ...
  //#region 9th ridge
  drawer
    .path(data.danero.head.horn.left['9']).stroke()
  ...
  //#region 10th ridge
  drawer
    .path(data.danero.head.horn.left['10']).stroke()
  ...
  //#region 11th ridge
  drawer
    .path(data.danero.head.horn.left['11']).stroke()
  ...
  //#region tip
  drawer
    .path(data.danero.head.horn.left.tip).stroke()
