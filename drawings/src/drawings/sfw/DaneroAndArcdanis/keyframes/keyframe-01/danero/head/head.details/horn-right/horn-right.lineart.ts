...
export const hornRightLineart = (drawer: Group) => {
  //#region 1st ridge
  drawer
    .path(data.danero.head.horn.right['1']).stroke()
    ...
    // left
    .curve(255, -19.7).absolute()
  //#endregion

  //#region 2nd ridge
  drawer
    .path(data.danero.head.horn.right['2']).stroke()
  ...
  //#region 3rd ridge
  drawer
    .path(data.danero.head.horn.right['3']).stroke()
  ...
  //#region 4th ridge
  drawer
    .path(data.danero.head.horn.right['4']).stroke()
  ...
  //#region 5th ridge
  drawer
    .path(data.danero.head.horn.right['5']).stroke()
  ...
  //#region 6th ridge
  drawer
    .path(data.danero.head.horn.right['6']).stroke()
  ...
  //#region 7th ridge
  drawer
    .path(data.danero.head.horn.right['7']).stroke()
  ...
  //#region 8th ridge
  drawer
    .path(data.danero.head.horn.right['8']).stroke()
  ...
  //#region 9th ridge
  drawer
    .path(data.danero.head.horn.right['9']).stroke()
  ...
  //#region 10th ridge
  drawer
    .path(data.danero.head.horn.right['10']).stroke()
  ...
  //#region 11th ridge
  drawer
    .path(data.danero.head.horn.right['11']).stroke()
  ...
  //#region tip
  drawer
    .path(data.danero.head.horn.right.tip).stroke()
